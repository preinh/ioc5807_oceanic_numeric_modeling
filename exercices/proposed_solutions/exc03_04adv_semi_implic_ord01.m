...
% POR METODO SEMI IMPLICITO DE PRIMEIRA PRIMEIRA ORDEM NO TEMPO E NO ESPACO.
...
for n=2:nmax
   ...
   dj(2:jmax-1)=fatu(2:jmax-1)-q*(fatu(3:jmax)-fatu(2:jmax-1));
   ...
   title(['Adveccao de sinal retangular (semi implic, 1a ordem) - tempo ',...
