...
Dh=0.25;            % coeficiente de difusao horizontal, em m2/s
qhu=dt*Dh/dx2;
qhv=dt*Dh/dy2;
concorte=0.0001;    % concentracao de corte para graficos
xgrid=((1:jmax)-1)*dx;
ygrid=((1:kmax)-1)*dy;
...
despejo=10;         % lancamento instantaneo

umed=0.075;   % velocidade media na direcao ew, em m/s
vmed=0.075;   % velocidade media na direcao ns, em m/s
...
jminplot=jdesp-10; jmaxplot=jdesp+80; kminplot=kdesp-10; kmaxplot=kdesp+80;
...
% plot de resultados
    if rem(n,freqplot)==0
        contourf(xgrid,ygrid,fren,[concorte:0.001:conmax]);
        grid;
